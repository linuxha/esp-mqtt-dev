...
int ICACHE_FLASH_ATTR test_anon_map_readwrite()
{    
...
int ICACHE_FLASH_ATTR test_anon_map_readonly()
{    
...
int ICACHE_FLASH_ATTR test_anon_map_writeonly()
{    
...
int ICACHE_FLASH_ATTR test_anon_map_readonly_nowrite()
{    
    void* map = mmap(NULL, 1024, PROT_READ,
 		      MAP_PRIVATE | MAP_ANONYMOUS, -1, 0);
    if (map == MAP_FAILED)
...
int ICACHE_FLASH_ATTR test_file_map_readwrite()
{
...
int ICACHE_FLASH_ATTR test_file_map_mlock_munlock()
{
...
int ICACHE_FLASH_ATTR test_file_map_msync()
{
    const size_t map_size = 1024;

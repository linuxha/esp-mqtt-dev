...
#
# This make file still needs some work. (and has had some work done ncherry@linuxha.com)
#
#
...
#ESPPATH=/opt/Espressif
ESPPATH=/home/njc/dev/esp8266/esp-open-sdk
# Base directory for the compiler
#XTENSA_TOOLS_ROOT ?= $(ESPPATH)/crosstool-NG/builds/xtensa-lx106-elf/bin
XTENSA_TOOLS_ROOT ?= $(ESPPATH)/xtensa-lx106-elf/bin
...
MODULES		= driver user easygpio mqtt rboot softuart rboot/appcode espfstes
...
LIBS		= gcc c hal phy pp net80211 wpa main lwip pwm
...
$1/%.o: %.c
	$(vecho) "CC $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CFLAGS) -c $$<"
	$(Q) $(CC) -DLINUX -mlongcalls $(INCDIR) $(MODULE_INCDIR) $(EXTRA_INCDIR) $(SDK_INCDIR) $(CFLAGS) -c $$< -o $$@
endef
